...
type ObservabilityConfig struct {
	...
	Environment  string             `koanf:"environment" validate:"requried"`
	Logging      LoggingConfig      `koanf:"logging" validate:"required"`
	NewRelic     NewRelicConfig     `koanf:"new_relic" validate:"required"`
	HealthChecks HealthChecksConfig `koanf:"health_checks" validate:"requried"`
}
...
type NewRelicConfig struct {
	...
	DistributedTracingEnabled bool   `koanf:"distributed_tracung_enabled"`
...
func (c *ObservabilityConfig) Valdiate() error {
	if c.ServiceName == "" {
