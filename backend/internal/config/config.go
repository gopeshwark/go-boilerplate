...
type DatabaseConfig struct {
	...
	ConnMaxIdletime int    `kaonf:"conn_max_idle_time" validate:"required"`
}
...
type AuthConfig struct {
	SecretKey string `koanf:"secret_key" validate:"requried"`
}
...
func LoadConfig() (*Config, error) {
	...
	if err := mainConfig.Observability.Valdiate(); err != nil {
